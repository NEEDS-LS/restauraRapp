...
Iremos usar como exemplo os dados do município de Buri, no estado de São Paulo. Nesse município estão localizado o campus [Lagoa do Sino](https://www.lagoadosino.ufscar.br/) da Universidade Federal de São Carlos ([UFSCar](https://www2.ufscar.br/))onde o [NEEDS](https://www.needs.ufscar.br/) fica locaizado.
...
propriedades<-separaTamanho(BURI_CAR)
...
Agora vamos executar a função *gCARapp()* que vai criar os buffers e recortar o uso de solo dentro das áreas definidas para restauração para cada classe de propriedades. Essa função demanda um poder de processamento consideravel e pode demorar, por esse motivo atualmente ela se econtra com um parâmetro para ser executada em partes, separada por classe de tamanho. Um parâmetro para execução completa será disponibilizada em breve.
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
REST_micro<-gCARapp(BURI_MDA, BURI_RMS, BURI_RMD, BURI_NAS, BURI_CAR, BURI_USO, tipo = "micro")
#REST_peq12<-gCARapp(BURI_MDA, BURI_RMS, BURI_RMD, BURI_NAS, BURI_CAR, BURI_USO, tipo = "peq12")
#REST_peq24<-gCARapp(BURI_MDA, BURI_RMS, BURI_RMD, BURI_NAS, BURI_CAR, BURI_USO, tipo = "peq24")
#REST_media<-gCARapp(BURI_MDA, BURI_RMS, BURI_RMD, BURI_NAS, BURI_CAR, BURI_USO, tipo = "media")
#REST_grand<-gCARapp(BURI_MDA, BURI_RMS, BURI_RMD, BURI_NAS, BURI_CAR, BURI_USO, tipo = "grande")
#REST_cena1<-gCARapp(BURI_MDA, BURI_RMS, BURI_RMD, BURI_NAS, BURI_CAR, BURI_USO, tipo = "out1")
#REST_cena2<-gCARapp(BURI_MDA, BURI_RMS, BURI_RMD, BURI_NAS, BURI_CAR, BURI_USO, tipo = "out2")
```
