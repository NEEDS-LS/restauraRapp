...
Agora vamos executar a função *CARapp_APP_buffer()* que vai criar os buffers e recortar o uso de solo dentro das áreas definidas para restauração para cada classe de propriedades. Essa função demanda um poder de processamento consideravel e pode demorar, por esse motivo atualmente ela se encontra com um parâmetro para ser executada em partes, separada por classe de tamanho. Um parâmetro para execução completa será disponibilizado em breve.
...
#                              BURI_NAS, BURI_CAR, BURI_USO, tipo = "peq12")
#REST_peq24<-CARapp_APP_buffer(BURI_MDA, BURI_RMS, BURI_RMD, 
#                              BURI_NAS, BURI_CAR, BURI_USO, tipo = "peq24")
