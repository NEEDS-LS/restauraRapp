#' Função que explode os polígonos em multipart e inclui os holes
#'
#' Essa função divide os polígonos que são multipartes
#' @param to.exp Objeto cujos polígonos estão em multiparte e precisam ser divididos
#' @return Frag SpatialPolygon ou SpatialPolygonsDataFrames com os polígonos separados
#' @export
#' @examples
#' shp.poligonos.single.parts<-gExplode(shp.poligonos.multipart)
#'
